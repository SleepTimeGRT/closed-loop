...
Run the full Harness workflow: Planner → Generator ↔ Evaluator feedback loop.
...
This is the main entry point for long-running autonomous development. The loop runs automatically — the user only needs to approve the initial spec.
